...
export const ja: Record<string, Record<string, string>> = {
  ...
  gdrive: {
    signIn: 'Google ドライブに接続',
    signOut: '接続を解除',
    signedInAs: '{email} でログイン中',
    saveToDrive: 'ドライブに保存',
    saveAllToDrive: '全てドライブに保存',
    saving: '保存中...',
    saved: '保存しました！',
    saveFailed: '保存に失敗しました',
    batchFromDrive: 'Google ドライブからバッチOCR',
    selectSourceFolder: '入力フォルダを選択',
    selectOutputFolder: '出力フォルダを選択（省略可）',
    ...
    cancel: 'キャンセル',
    close: '閉じる',
    folderEmpty: 'このフォルダにPDFがありません',
    downloading: 'ダウンロード中...',
    processing: 'OCR処理中...',
    savingDoc: 'ドキュメントに保存中...',
    done: '完了',
    error: 'エラー',
    batchComplete: 'バッチ処理が完了しました ({done}/{total} ファイル)',
    batchError: '一部のファイルでエラーが発生しました',
    viewDoc: 'ドキュメントを開く',
    pdfCount: '{count} 件のPDFが見つかりました',
  },
} as const
